...
export default function NewsIndexPage() {
  ...
  return (
    <section className="pb-10 pt-12 sm:pb-14 sm:pt-14">
      <Container>
        ...
        <Reveal variant="hero">
          <PageHero
            ...
            kicker="Aktualno"
            title="Novice"
            desc="Aktualno iz podjetja in projekti."
          />
        </Reveal>
      ...
      {/* List */}
{rest.length ? (
  <div className="mt-10 overflow-hidden rounded-2xl border border-neutral-200 divide-y divide-neutral-200/70 bg-white">
    {rest.map((item) => (
      <div
        key={item.slug}
        className="transition-colors duration-200 hover:bg-[var(--hover-tint)]"
        style={
          {
            ["--hover-tint" as any]:
