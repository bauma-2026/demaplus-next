...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-footer bg-footer py-14 sm:py-16">
      <Container>
        <div className="py-14 flex flex-col gap-10 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-col items-start gap-3 text-sm sm:items-end">
            ...
            <div className="flex flex-col gap-2 sm:items-end">
              <Link
                ...
                className="text-neutral-700 underline underline-offset-4 decoration-neutral-400 transition hover:text-neutral-900 hover:decoration-neutral-700"
              >
